package com.green.announce.Controller;
...
import com.green.announce.Service.AnnounceService;
import com.green.announce.utility.PageUtil;
...
public class AnnounceController {
    ...
    @PostMapping("save")
    public ResponseEntity<Announce> save(@AuthenticationPrincipal LoginUserDetails loginUserDetails,
                                         @Valid @RequestBody AnnounceReqDto announceReqDto) {
